...
namespace RGB
{
    internal class Program
    {
        ...
        public static string[] test = { "aaaaaaaaaaaaaa", "bbbbbbbbbbbbbb" };
        public static char char_marco = '█';
        ...
        public static void Marco(string linea)
        {
            //Texto
        ...
        public static void Marco(string [] lineas) // █▓▒░
        {
            try
            {         
                //Primera linea
